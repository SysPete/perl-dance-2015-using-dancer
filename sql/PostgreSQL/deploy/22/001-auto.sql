...
CREATE TABLE "cart_products" (
  ...
  "combine" boolean DEFAULT '1' NOT NULL,
  "extra" text,
  "created" timestamp NOT NULL,
  "last_modified" timestamp NOT NULL,
...
CREATE TABLE "orderlines" (
  ...
  "price" numeric(21,3) NOT NULL,
  "subtotal" numeric(21,3) NOT NULL,
  "shipping" numeric(21,3) DEFAULT 0 NOT NULL,
  "handling" numeric(21,3) DEFAULT 0 NOT NULL,
  "salestax" numeric(21,3) DEFAULT 0 NOT NULL,
...
CREATE TABLE "products" (
  ...
  "short_description" character varying(500) DEFAULT '' NOT NULL,
  "description" text NOT NULL,
  "price" numeric(21,3) DEFAULT 0 NOT NULL,
  "uri" character varying(255),
...
CREATE TABLE "orders" (
  ...
  "weight" numeric(11,3) DEFAULT 0 NOT NULL,
  ...
  "subtotal" numeric(21,3) DEFAULT 0 NOT NULL,
  "shipping" numeric(21,3) DEFAULT 0 NOT NULL,
  "handling" numeric(21,3) DEFAULT 0 NOT NULL,
  "salestax" numeric(21,3) DEFAULT 0 NOT NULL,
  "total_cost" numeric(21,3) DEFAULT 0 NOT NULL,
...
CREATE TABLE "payment_orders" (
  ...
  "sessions_id" character varying(255),
  "orders_id" integer,
  "amount" numeric(21,3) DEFAULT 0 NOT NULL,
  ...
  "payment_fee" numeric(12,3) DEFAULT 0 NOT NULL,
  "created" timestamp NOT NULL,
  "last_modified" timestamp NOT NULL,
...
CREATE TABLE "users" (
  ...
  "email" character varying(255) DEFAULT '' NOT NULL,
  "password" character varying(2048) DEFAULT '*' NOT NULL,
  "first_name" character varying(255) DEFAULT '' NOT NULL,
  "last_name" character varying(255) DEFAULT '' NOT NULL,
  ...
  "guru_level" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "orderlines_shippings" (
  ...
  "quantity" integer NOT NULL,
  PRIMARY KEY ("orderlines_id", "addresses_id", "shipments_id")
);
...
CREATE TABLE "talks" (
  ...
  "abstract" character varying(2048) DEFAULT '' NOT NULL,
  "url" character varying(255) DEFAULT '' NOT NULL,
  "video_url" character varying(255) DEFAULT '' NOT NULL,
